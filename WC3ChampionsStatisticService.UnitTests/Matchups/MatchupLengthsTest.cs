...
public class MatchupLengthsTest : IntegrationTestBase
{
    ...
    public async Task MatchupLengthsTest_MatchupLengthsAreOK()
    {
        ...
        var gameLengthForPlayerStatistic1 = await statsRepo.LoadMatchupLengthOrCreate(Race.HU.ToString(), Race.NE.ToString(), 5);


        // Hu vs NE should have 2 games with the key 180
        Assert.True(gameLengthForPlayerStatistic1.LengthsByMmrRange.ContainsKey("all"));
        Assert.AreEqual(121, gameLengthForPlayerStatistic1.LengthsByMmrRange["all"].Count);
        Assert.AreEqual(1, gameLengthForPlayerStatistic1.LengthsByMmrRange["all"][6].Games);
        Assert.AreEqual(1, gameLengthForPlayerStatistic1.LengthsByMmrRange["all"][7].Games);
        Assert.AreEqual(180, gameLengthForPlayerStatistic1.LengthsByMmrRange["all"][6].Seconds);
        Assert.AreEqual(210, gameLengthForPlayerStatistic1.LengthsByMmrRange["all"][7].Seconds);

        // same on mmr 1600
        Assert.True(gameLengthForPlayerStatistic1.LengthsByMmrRange.ContainsKey("1600"));
        Assert.True(gameLengthForPlayerStatistic1.LengthsByMmrRange.ContainsKey("1400"));
        Assert.AreEqual(121, gameLengthForPlayerStatistic1.LengthsByMmrRange["1600"].Count);
        Assert.AreEqual(121, gameLengthForPlayerStatistic1.LengthsByMmrRange["1400"].Count);
        Assert.AreEqual(1, gameLengthForPlayerStatistic1.LengthsByMmrRange["1600"][6].Games);
        Assert.AreEqual(1, gameLengthForPlayerStatistic1.LengthsByMmrRange["1400"][7].Games);
        Assert.AreEqual(180, gameLengthForPlayerStatistic1.LengthsByMmrRange["1600"][6].Seconds);
        Assert.AreEqual(210, gameLengthForPlayerStatistic1.LengthsByMmrRange["1400"][7].Seconds);
